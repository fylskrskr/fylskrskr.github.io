...
I received my Master’s degree in Artificial Intelligence from **Shanghai Jiao Tong University (SJTU)**, working with Prof. Yue Zhou on computer vision at the [Institute of Image Processing and Pattern Recognition](http://www.pami.sjtu.edu.cn/). Prior to that, I obtained my Bachelor’s degree in Automation from **Xi’an Jiaotong University (XJTU)**.
